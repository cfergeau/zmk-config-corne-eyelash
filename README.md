This is the core module for the [Eyelash Corne](https://github.com/a741725193/zmk-new_corne) keyboard.

Users really should not use this directly, but instead use it as an [external module](https://zmk.dev/docs/features/modules#building-with-modules) in a repository with a `config` directory defining the keyboard config and a user keymap.
